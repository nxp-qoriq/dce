...
#ifndef __SINGLE_CHUNK_COMP_H
#define __SINGLE_CHUNK_COMP_H
void single_chunk_compress(struct qbman_swp *swp,
				...
				struct dma_mem *mem)
{
	...
	memcpy(addr, dce_test_data, chunk_sz);
	...
	dpaa2_fd_set_len(&output_fd, chunk_sz / 2);
